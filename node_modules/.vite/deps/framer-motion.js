...
function animateElements(elementOrSelector, keyframes2, options, scope) {
  ...
  for (let i = 0; i < numElements; i++) {
    ...
    animations2.push(...animateTarget(visualElement, { ...keyframes2, transition: options }, {}));
  }
  return new GroupPlaybackControls(animations2);
}
var createScopedAnimate = (scope) => {
  function scopedAnimate(valueOrElement, keyframes2, options = {}) {
    let animation;
    if (isDOMKeyframes(keyframes2)) {
      animation = animateElements(valueOrElement, keyframes2, options, scope);
    } else {
      animation = animateSingleValue(valueOrElement, keyframes2, options);
    }
    if (scope) {
